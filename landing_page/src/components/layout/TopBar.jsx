...
export default function TopBar() {
  return (
    <header className="flex items-center justify-end bg-white border-b px-4 py-3 my-4 mx-3 shadow-lg relative" style={{borderRadius : "20px"}}>
      ...
      {/* Search */}
      <div className="relative w-1/3 mr-[13.09px] shadow-sm" style={{borderRadius : "3.62px"}}>
